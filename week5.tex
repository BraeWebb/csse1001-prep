...
\includegraphics[height=0.9\textheight]{bad_python/bad_naming}
\end{topic}

\begin{topic}{Good: Meaningful variable names}
\includegraphics[height=0.9\textheight]{bad_python/good_naming}
\end{topic}
...
\includegraphics[height=0.9\textheight]{bad_python/incorrect}
(note that the implementations are completely absurd...)
\end{topic}

\begin{topic}{Good: Following the spec exactly}
\includegraphics[height=0.9\textheight]{bad_python/correct}
(note that the implementations are completely absurd...)
\end{topic}
