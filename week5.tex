...
\includegraphics[height=\textheight]{bad_python/bad_naming}
\end{topic}

\begin{topic}{Good: Meaningful variable names}
\includegraphics[height=\textheight]{bad_python/good_naming}
\end{topic}

\begin{topic}{Bad: Lengthy functions}
\includegraphics[height=\textheight]{bad_python/long}
\end{topic}

\begin{topic}{Good: Functional decomposition and good use of control structures}
\includegraphics[height=\textheight]{bad_python/short}
\end{topic}
