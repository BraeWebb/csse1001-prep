...
\begin{topic}{Easy marks}
Perhaps the easiest marks to get in the assignment were for documentation

\begin{subtopic}{2-}
Follow the docstring guide in the course notes
\end{subtopic}

\begin{subtopic}{3-}
Documentation marks also include inline comments
\end{subtopic}
\end{topic}
\end{topic}
